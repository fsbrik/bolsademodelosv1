    ...
    <x-slot name="content">
        <div class="grid grid-cols-1 md:grid md:grid-cols-12 md:gap-3">
            ...
            <div class="col-span-12 sm:col-span-1">
                ...
                <x-input id="estatura" type="number" class="mt-1 block w-2/3" wire:model="modelo.estatura"
                    step="0.01" disabled />
            ...
            <div class="col-span-12 sm:col-span-1">
                ...
                <x-input id="estado" type="text" :class="$modelo['estado'] == 1 ? 'bg-green-500 mt-1 block w-full' : 'bg-red-500 mt-1 block w-full'"
            ...
            @if (Auth::user()->hasRole('admin'))
                ...
                <div class="col-span-12 sm:col-span-11">
                    ...
                    <x-input id="estado" type="text" class="mt-1 block w-8  "
                        value="{{ $this->habilita_display }}" disabled />
