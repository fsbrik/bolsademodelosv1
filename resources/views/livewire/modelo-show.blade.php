<div class="grid grid-cols-1 md:grid md:grid-cols-12 md:gap-3">
    ...
    <div class="col-span-12 sm:col-span-3">
        ...
        <x-input id="tar_med" type="number" class="mt-1 block w-1/3" wire:model="modelo.tar_med" step="0.01"
            disabled />
    ...
    <div class="col-span-12 sm:col-span-9">
        ...
        <x-input id="tar_com" type="number" class="mt-1 block w-1/9" wire:model="modelo.tar_com" step="0.01"
            disabled />
