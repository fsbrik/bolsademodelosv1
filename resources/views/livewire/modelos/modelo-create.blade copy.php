                        ...
                        <div class="grid grid-cols-1 md:grid md:grid-cols-12 md:gap-3">
                            ...
                            <div class="col-span-12 sm:col-span-2">
                                ...
                                <select id="dis_tra" name="dis_tra"
                                    class="block mt-1 w-1/2 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    <option value="-" {{ old('dis_tra') == '-' ? 'selected' : '' }}>
                                        {{ __('-') }}</option>
                                    <option value="modelo" {{ old('dis_tra') == 'modelo' ? 'selected' : '' }}>
                                        {{ __('Modelo') }}</option>
                                    <option value="promotor/a" {{ old('dis_tra') == 'promotor/a' ? 'selected' : '' }}>
                                        {{ __('Promotor/a') }}</option>
                                    <option value="ambos" {{ old('dis_tra') == 'ambos' ? 'selected' : '' }}>
                                        {{ __('Ambos') }}</option>
                                </select>
                            ...
                            <div class="col-span-12 sm:col-span-5">
                                ...
                                <select id="dis_via" name="dis_via"
                                    ...
                                    <option value="-" {{ old('dis_via') == '-' ? 'selected' : '' }}>
                                        {{ __('-') }}</option>
                            ...
                            <div class="col-span-12 sm:col-span-2">
                                ...
                                <select id="col_cab" name="col_cab"
                                    class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    <option value="-" {{ old('dis_via') == '-' ? 'selected' : '' }}>{{ __('-') }}</option>
                                    <option value="rubio" {{ old('col_cab') == '-' ? 'selected' : '' }}>{{ __('Rubio') }}</option>
                                    <option value="castaño" {{ old('col_cab') == '-' ? 'selected' : '' }}>{{ __('Castaño') }}</option>
                                    <option value="pelirrojo" {{ old('col_cab') == '-' ? 'selected' : '' }}>{{ __('Pelirrojo') }}</option>
                                    <option value="morocho" {{ old('col_cab') == '-' ? 'selected' : '' }}>{{ __('Morocho') }}</option>
                                    <option value="otro" {{ old('col_cab') == '-' ? 'selected' : '' }}>{{ __('Otro') }}</option>
                                </select>
                            ...
                            <div class="col-span-12 sm:col-span-2">
                                ...
                                <select id="tit_mod" name="tit_mod"
                                    class="block mt-1 w-1/3 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    <option value="-" {{ old('tit_mod') == '-' ? 'selected' : '' }}>
                                        {{ __('-') }}</option>
                            ...
                            <div class="col-span-12 sm:col-span-2">
                                ...
                                <select id="ingles" name="ingles"
                                    class="block mt-1 w-2/3 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    <option value="-" {{ old('ingles') == '-' ? 'selected' : '' }}>
                                        {{ __('-') }}
                                    <option value="basico" {{ old('ingles') == 'basico' ? 'selected' : '' }}>
                                        {{ __('Básico') }} </option>
                                    <option value="intermedio" {{ old('ingles') == 'intermedio' ? 'selected' : '' }}>
                                        {{ __('Intermedio') }}</option>
                                    <option value="avanzado" {{ old('ingles') == 'avanzado' ? 'selected' : '' }}>
                                        {{ __('Avanzado') }}</option>
                                </select>
