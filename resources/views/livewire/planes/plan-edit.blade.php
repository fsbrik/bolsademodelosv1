<div>
    <x-slot name="header">
        <x-header bold='true'>
            {{ __('Modificá tu plan seleccionado') }}
        </x-header>
    </x-slot>
    <x-container>
        <section id="messages">
        ...
        @livewire('forms.tarjetas-planes', ['planId' => $plan->id, 'tipoDeRuta' => 'edit'])
    ...
    {{-- <div class="container max-w-5xl mx-auto px-6 mt-10">
        <div class="flex flex-col lg:flex-row px-2 lg:px-0">
            <!-- Plan Simple -->
            <div
                class="flex flex-col w-full sm:w-auto md:w-2/3 lg:w-1/3 {{ $selectedPlan === 'plan simple' ? 'bg-purple-500' : 'bg-purple-300' }}
            ...
            {{-- <div class="w-full md:w-1/3 text-white bg-purple-700 rounded-lg shadow hover:shadow-xl transition duration-100 ease-in-out p-6 md:mr-4 mb-10 md:mb-0">
             ...
             {{--<div
                class="flex flex-col w-full md:w-auto lg:w-1/3 {{ $selectedPlan === 'plan mensual' ? 'bg-purple-500' : 'bg-purple-300' }}
                    rounded-lg shadow hover:shadow-xl transition duration-100 ease-in-out p-6 md:mx-auto lg:mr-4 mb-5">
                <div class="flex flex-col flex-grow mx-auto">
            ...
            <!-- Plan Anual (Full) -->
            <div
                class="flex flex-col w-full md:w-auto lg:w-1/3 {{ $selectedPlan === 'plan anual' ? 'bg-purple-500' : 'bg-purple-300' }}
                    rounded-lg shadow hover:shadow-xl transition duration-100 ease-in-out p-6 md:mx-auto lg:mr-4 mb-5">
                <div class="flex flex-col flex-grow mx-auto">
