<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select id="sexo" wire:model="modelo.sexo" disabled
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="calzado" type="text" class="mt-1 block w-full" wire:model="modelo.calzado" disabled/>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select id="zon_res" wire:model="modelo.zon_res" disabled
                class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select id="dis_via" wire:model="modelo.dis_via" disabled
                class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select id="tit_mod" wire:model="modelo.tit_mod" disabled
                class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                <option value="1">{{ __('Sí') }}</option>
                <option value="0">{{ __('No') }}</option>
            </select>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select id="ingles" wire:model="modelo.ingles" disabled
                class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select id="dis_tra" wire:model="modelo.dis_tra" disabled
                class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        <div class="col-span-6 sm:col-span-4">
            <div class="col-span-6 sm:col-span-4 flex items-center">
                ...
                <select id="estado" wire:model="modelo.estado" disabled
                    class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        <div class="col-span-6 sm:col-span-4">
            <div class="col-span-6 sm:col-span-4 flex items-center">
                ...
                <select id="habilita" wire:model="modelo.habilita" disabled
                    class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
