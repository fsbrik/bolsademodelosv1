                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('empresas.store') }}">
                        ...
                        <div>
                            ...
                            <x-input id="nom_com" class="block mt-1 w-full" type="text" name="nom_com" :value="old('nom_com')" required autofocus />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="rubro" class="block mt-1 w-full" type="text" name="rubro" :value="old('rubro')" required />
                        </div>
