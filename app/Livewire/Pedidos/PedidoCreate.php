...
class PedidoCreate extends Component
{
    ...
    public function render()
    {
        ...
        elseif($this->selectedUser->hasRole('modelo'))
        {
            return view('livewire.pedidos.pedido-create', ['user' => $this->selectedUser]);
        }
        elseif($this->selectedUser->hasRole('empresa'))
        {
            return view('livewire.pedidos.pedido-create', ['user' => $this->selectedUser, 'empresas' => $this->empresas]);
        }
