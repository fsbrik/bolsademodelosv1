...
class ModeloUser extends Component
{

    public $user, $modeloId, $photo, $profile_photo_path, $profile_photo_url, $name;
    public $state = [];
    ...
    public function mount($modeloId)
    {
        ...
        $this->user = $modelo->user;
        $this->state = $modelo->user->only('name', 'email', 'telefono');
        //$photo = $modelo->user->
        $this->profile_photo_url = $modelo->user->profile_photo_url;
        $this->name = $modelo->user->name;
        $this->profile_photo_path = $modelo->user->profile_photo_path;
    ...
    {
        return view('livewire.admin.modelo-user');
    }
}
